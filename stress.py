...
def register():
    ...
    if request.method == 'POST':
        # and 'username' in request.form and 'password' in request.form and 'email' in request.form and 'mobile' in request.form and'loginid' in request.form and 'address' in request.form and 'company' in request.form and 'state' in request.form:
